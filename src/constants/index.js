...
const experiences = [
  {
    ...
    points: [
      "Architected an AI-driven career development system, leveraging LLMs and NestJS for backend, which reduced operational expenses by 20% through automated profile and career path suggestions.",
      "Refactored system design to an async architecture, integrating React.js for a responsive user interface and Redis Queue for backend processing, cutting user wait times to 600ms and enhancing overall system responsiveness.",
      "Engineered an AI-powered project assistant using React.js, implemented NLP techniques such as LSTM and zero-shot classification within a NestJS framework to automate task creation and tracking, significantly improving project management efficiency.",
    ],
  },
  {
  ...
  },
  {
    ...
    points: [
      "Pioneered the adoption of Angular in a legacy CRM system, leading to a modernized interface that improved user engagement by enhancing accessibility and interactive elements.",
      "Employed Agile methodologies to revamp backend services using Node.js and Express.js, which streamlined server-side logic and reduced latency in customer-facing applications by 45%.",
      "Orchestrated the deployment of scalable microservices architecture using Docker and Kubernetes, leveraging AWS Elastic Kubernetes Service (EKS) and AWS EC2 for efficient scaling, reducing system downtime and operational costs by 25%.",
    ],
  },
  {
    ...
    points: [
      "Developed a client-facing dashboard using React.js and TypeScript, which increased user engagement by 40% by providing real-time data visualization and interactive analytics features.",
      "Constructed RESTful APIs for a cross-platform mobile app for 50K+ active users and integrated Stripe for seamless payment processing within a B2B e-commerce platform.",
      "Enhanced NoSQL database schemas with MongoDB, which improved data access speeds by 50% for high-traffic applications.",
    ],
  },
];
